...
const BelanjaDetail = () => {
  ...
  return (
    <div className="container mx-auto p-5">
      <Button onClick={handleOpenModal} className="text-blue-500 hover:underline mb-5 inline-block">View Details</Button>
      <Modal isOpen={isModalOpen} onRequestClose={handleCloseModal} contentLabel="Post Detail Modal">
        <div className="p-5">
          <button onClick={handleCloseModal} className="text-blue-500 hover:underline mb-5 inline-block">Back to List</button>
